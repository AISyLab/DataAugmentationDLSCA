...
for desync_level in [25, 50, 75, 100, 125, 150, 175, 200]:
    ...
    for color, desync_level_augmentation in enumerate(desync_level_augmentation_dict[desync_level]):
        ...
        for n_augmented in range(20000, 210000, 20000):
            ...
            file_id_aug = file_id_dict_id[desync_level] if leakage_model == "ID" else file_id_dict_hw[desync_level]
            ...
            augmentation = f"n_prof_{n_prof}_n_augmented_{n_augmented}_desync_file_id_{file_id_aug}"
